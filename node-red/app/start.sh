...
cd /usr/local/bin
./rs485_DE /dev/ttyAMA2 /dev/gpiochip0 6 /dev/ttyAMA10 /dev/gpiochip2 12 & 
./rs485_DE /dev/ttyAMA5 /dev/gpiochip0 24 /dev/ttyAMA12 & 
./rs485_DE /dev/ttyAMA3 /dev/gpiochip0 17 /dev/ttyAMA11 & 
